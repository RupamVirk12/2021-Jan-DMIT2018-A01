    ...
    <div class="row">
        <div class="offset-2">
            <blockquote class="alert alert-info">
                ...
                This page will use the ObjectDataSource with the ListView control<br />
                This page will use the minimum code behind<br />
                This page will use the MessageUserControl for the error handling<br />
    ...
    <div class="row">
        <div class="offset-2">
            ...
            <asp:ValidationSummary ID="ValidationSummaryEdit" runat="server"
                 HeaderText="Following are the concerns with your data."
    ...
    <div class="row">
        <div class="offset-1">
            ...
            <asp:ListView ID="AlbumList" runat="server"
                ...
                <AlternatingItemTemplate>
                    <tr style="background-color: #FFFFFF; color: #284775;">
                        ...
                        <td>
                            ...
                            <asp:DropDownList ID="ArtistList" runat="server" DataSourceID="ArtistListODS" DataTextField="DisplayField" DataValueField="ValueField"
                ...
                <%--for editing--%>
                <EditItemTemplate>
                    <%-- Validation control will be placed inside the associate template.The ID of the validated control needs to be unique.The validation controls of a particular template needs to be grouped
                        
                        The validation executes ONLY on the use of thr template by the user--%>
                    <asp:RequiredFieldValidator ID="RequiredTitleE" runat="server" ErrorMessage="Album title is required on edit."
                        ControlToValidate="TitleTextBoxE" Display="None"
                         ValidationGroup="egroup"></asp:RequiredFieldValidator>

                     <asp:RequiredFieldValidator ID="RequiredReleaseYearE" runat="server" ErrorMessage="Album year is required on edit."
                        ControlToValidate="ReleaseYearTextBoxE" Display="None"
                         ValidationGroup="egroup"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegExTitleE" runat="server" ErrorMessage="Album title is limited to 160 characters"
                        ControlToValidate="TitleTextBoxE" Display="None"
                         ValidationGroup="egroup"
                         ValidationExpression="^.{1-160}$"></asp:RegularExpressionValidator>

                     <asp:RegularExpressionValidator ID="RegExReleaseLabelE" runat="server" ErrorMessage="Album Label is limited to 50 characters"
                    ...
                    <asp:RangeValidator ID="RangeReleaseYearE" runat="server" ErrorMessage="Year must be between 1950 and this year"
                         ControlToValidate="ReleaseYearTextBoxE" Display="None"
                         ValidationGroup="egroup"
                    ...
                    <tr style="background-color: #999999;">
                        ...
                        <td>
                            <asp:TextBox Text='<%# Bind("AlbumId") %>' runat="server" ID="AlbumIdTextBox" Width="50px" Enabled="false" />
                        </td>
                        <td>
                ...
                <%-- for inserting --%>
                <InsertItemTemplate>
                     <asp:RequiredFieldValidator ID="RequiredTitleI" runat="server" ErrorMessage="Album title is required on edit."
                        ControlToValidate="TitleTextBoxI" Display="None"
                         ValidationGroup="igroup"></asp:RequiredFieldValidator>

                     <asp:RequiredFieldValidator ID="RequiredReleaseYearI" runat="server" ErrorMessage="Album year is required on edit."
                        ControlToValidate="ReleaseYearTextBoxI" Display="None"
                         ValidationGroup="igroup"></asp:RequiredFieldValidator>

                    <asp:RegularExpressionValidator ID="RegExTitleI" runat="server" ErrorMessage="Album title is limited to 160 characters"
                        ControlToValidate="TitleTextBoxI" Display="None"
                         ValidationGroup="igroup"
                         ValidationExpression="^.{1-160}$"></asp:RegularExpressionValidator>

                     <asp:RegularExpressionValidator ID="RegExReleaseLabelI" runat="server" ErrorMessage="Album Label is limited to 50 characters"
                    ...
                    <asp:RangeValidator ID="RangeReleaseYearI" runat="server" ErrorMessage="Year must be between 1950 and this year"
                         ControlToValidate="ReleaseYearTextBoxI" Display="None"
                         ValidationGroup="igroup"
                         MinimumValue="1950" MaximumValue="<%# DateTime.Today.Year %>"></asp:RangeValidator>
                    <tr style="">
                ...
                <%--/mininum the list view has item template and layout template
               Layout table - used for table layout --%>
                <LayoutTemplate>
                    <table runat="server">
                        <tr runat="server">
                            <td runat="server">
                                <table runat="server" id="itemPlaceholderContainer" style="background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;" border="1">
                                    ...
                                    <%-- This is the row that actually shows the data --%>
                ...
                <SelectedItemTemplate>
                    <tr style="background-color: #E2DED6; font-weight: bold; color: #333333;">
                        ...
                        <td>
                            <asp:DropDownList ID="ArtistList" runat="server" DataSourceID="ArtistListODS" DataTextField="DisplayField" DataValueField="ValueField"
                                SelectedValue='<%# Eval("ArtistId") %>' Width="300px" Enabled="false">
                            </asp:DropDownList></td>
                        <td>
                            <asp:Label Text='<%# Eval("Title") %>' runat="server" ID="TitleLabel" /></td>
                        <td>
            ...
            <asp:ObjectDataSource ID="AlbumListODS" runat="server" DataObjectTypeName="ChinookSystem.ViewModels.AlbumItem" DeleteMethod="Albums_Delete"
            ...
            <%-- ODS for Artist DDL in ListView --%>
            <asp:ObjectDataSource ID="ArtistListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Artist_DDLList"
                OnSelected="SelectCheckForException"
