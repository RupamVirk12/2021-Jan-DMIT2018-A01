...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="offset-3">
            <asp:Label ID="ArtistLabel" runat="server" Text="Select an Artist"></asp:Label>&nbsp;&nbsp;
        ...
        <div class="row">
            <div class ="offset=3">
                <asp:GridView ID="ArtistAlbumList" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
